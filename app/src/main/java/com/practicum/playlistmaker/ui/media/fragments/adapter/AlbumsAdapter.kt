...
class AlbumsAdapter(private val albums: List<Album>,private val context: Context?): RecyclerView.Adapter<AlbumsViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AlbumsViewHolder {
        val binding = ItemPlaylistBinding.inflate(LayoutInflater.from(parent.context),parent,false)
        return AlbumsViewHolder(binding,context)
    }
